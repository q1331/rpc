...
func (c *shutdownCodec) ReadRequestHeader(*Request) error           {return nil}
func (c *shutdownCodec) ReadRequestBody(interface{}) error          {return nil}
func (c *shutdownCodec) WriteResponse(*Response, interface{}) error {return nil}
